...
const Commissions = () => {
    ...
    return (
        <div className={`relative`}>
            <Image src={`/images/commissionsglow.png`} width={1502} height={1424} alt={`glow`} className={`absolute top-[-300px] right-0 l:w-full m:max-h-[2000px] object-cover m:top-[-96px]`}/>
