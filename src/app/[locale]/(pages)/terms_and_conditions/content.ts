export const terms = [
    {
        ...
        items: [
            ...
            "“Company” shall mean company within our group, including our parent companies, their parent companies and all of the subsidiaries of these respective companies.",
            "“Company Websites” means any website (including mirror websites) which is maintained, operated or otherwise controlled by the Affiliate.",
            ...
            "“Net Gaming Revenue (NGR)” means all player stakes from referred customers, less: winnings paid, issued bonuses, admin or fraud fees, chargebacks or refunds. For the avoidance of doubt, all Net Gaming Revenue amounts mentioned above are only related to New Customers referred to Company Websites by the Affiliate Website(s).",
            "“New Customer” means a new, first-time customer of the Company who: (i) who is permitted under applicable law to use the Affiliate Website, (ii) accessed Company Website after being directed through the Affiliate Link, (iii) completes the applicable registration process, (iv) agrees and accepts Company Website’s Terms and Conditions and/or other agreements, (v) opens a new account with Company Websites, (vi) made a first deposit amounting to at least the applicable minimum deposit at Company Websites’ player account, in accordance with the applicable terms and conditions of Company Websites and (vii) such account and/or payment has not been canceled, terminated, refunded or charged back; provided other applicable terms, conditions and requirements of this Agreement’. This excludes the Affiliate, its employees, relatives and friends.",
            "“Parties” means Company and the Affiliate (each separately a “Party”).",
    ...
    },
    {
        ...
        items: ["2.1 Affiliate Registration",
            "To become a member of our Affiliate Program, you must accept these terms and conditions when submitting the Affiliate Application. The Affiliate Application will form an integral part of the Affiliate Agreement.",
            "We will determine, at our sole discretion, whether to approve or reject your application. We will notify you by email as to whether or not your Affiliate Application has been successful. We reserve the right not to approve your Affiliate Application and not to disclose the reasons for our decision.",
            "You may be required to provide documentation for identity verification or compliance at any time. This documentation may include but is not limited to: bank statements, individual or corporate identity papers and proof of address.",
            "You are responsible for ensuring that the information provided is accurate and up to date. You are also responsible for keeping your login details confidential and secure. Unauthorized use of your account due to your failure to protect credentials is your responsibility.",
            "We reserve the right to suspend or terminate your account if any information is found to be false, misleading, or incomplete, or if you fail to provide requested documentation within a reasonable timeframe.",
            ...
            "Use of branded keywords (e.g. \"Dreamplay\") in contextual advertising (e.g. Google Ads) is strictly prohibited.",
            ...
            "If a referred player is suspected of engaging in fraudulent activity such as bonus abuse or money laundering, you must notify us immediately. Commission will not be paid on such users.",
            "Player winnings between the 20th–31st of any month that are not played through in the following month may be excluded from RevShare or Hybrid commission calculations.",
            "If 50% or more of your referred players in a month: make only the minimum deposit, make just one or two small deposits, or show low or no gameplay activity, we may consider your traffic motivated. In such cases, we reserve the right to freeze or withhold commissions for that month.",

            "2.6 Traffic Review & Suspensions",
            "The Company reserves the right to suspend or withhold your traffic at any time in order to conduct quality assurance, compliance, or fraud checks. During such reviews, any new players referred by you may be placed on hold, and associated commissions may be temporarily withheld. New player acquisitions during this period will not be eligible for commissions unless and until they are explicitly approved by the Company.",
            "The Company further reserves the right to retroactively reverse commissions or terminate the agreement if fraudulent, incentivized, or low-quality traffic is detected.",
    ...
    },
    {
        ...
        items: [
            ...
            "We grant you the non-exclusive, non-assignable, right, during the term of this Affiliate Agreement, to direct New Customers to such Company Websites as we have agreed with you in strict accordance with the terms of the Affiliate Agreement.",
            "You shall have no claim to Commission or other compensation on business secured by persons or entities other than you.",

            "3.2. Licence to use Company Intellectual Property Rights",
            "We grant to you a non-exclusive, non-transferable licence, during the term of this Affiliate Agreement, to use the Company Intellectual Property Rights, which we may from time to time approve solely in connection with the display of the promotional materials on the Affiliate Website or in other such locations as may have been expressly approved (in writing) by Company.",
    ...
    },
    {
        ...
        items: [
            ...
            "4.2. At our sole discretion, we will register any New Customers directed to the Company Websites by you and we will track their transactions.",
            "We reserve the right to refuse New Customers (or to close their accounts) if necessary to comply with any requirements we may periodically establish.",
    ...
    },
    {
        ...
        items: [
            ...
            "6.5. If an error is made in the calculation of the Commission, the Company has the right to correct such calculation at any time and will immediately pay out underpayment or reclaim overpayment made to the Affiliate. In the event of an overpayment, the Company reserves the right to reclaim the excess amount, either by offsetting it against future payments or by invoicing the Affiliate directly.",
            ...
            "6.7. The Affiliate’s acceptance of a Commission payment shall constitute the full and final settlement of the balance due for the relevant period. In case the Affiliate disagrees with the balance due as reported, he or she shall notify the Company within fourteen (14) calendar days and clearly state reasons of the disagreement. Failure to notify the Company within this time limit shall be considered as an irrevocable acknowledgment of the balance due for the relevant period and the acceptance of the payment as final.",

            "6.8. The Commission shall be deemed to be exclusive of value added tax or any other applicable tax. The Affiliate shall have the sole responsibility to pay any and all taxes, levies, charges and any other money payable or due to any tax authority, department or other competent entity as a result of the compensation generated under the Affiliate Agreement. In addition, the Affiliate shall bear any bank charges, transaction fees, or other costs incurred in receiving the Commission payments.",

            "6.9. All payments via wire transfer and E-payments will be made in USD or EUR, at Our sole discretion. In case the payment currency is different from the statistics currency, the exchange rate used for conversion will be the exchange rate quoted by Our bank.",
            ...
            "- The initial test cap is paid, if an Affiliate is able to generate at least 10 FTDs (for any brand) facing all discussed requirements.",

            "- If not, we reserve a right not to proceed the withdrawal up until the requirements discussed beforehand are fulfilled.",

            "- A first time deposit (lead) that is being generated from: FB, e-mail, SMS, UAC sources is paid if a deposit was made within 30 days since a lead had made a registration. A lead who made a first time deposit after a specified period of time (30 days) is not paid.",
            ...
            "- A first time deposit (lead) that is being generated from SEO or ASO source is paid if a deposit was made within 60 days since a lead had made a registration. A lead who made a first time deposit after a specified period of time (60 days) is not paid.",

            "- The initial test cap is paid, if an Affiliate is able to generate at least 10 FTDs (for any brand) facing all discussed requirements.",

            "- If not, we reserve a right not to proceed the withdrawal up until the requirements discussed beforehand are fulfilled.",

            "Note! In the event that a link associated with a CPA and Hybrid deal fails to register any valid First-Time Deposits (FTDs) within the span of 30 days following its establishment, said link shall be rendered inactive and shall not accrue commissions.",

            "It is the obligation of the partner to apprise the company in the event that the link remains unused on account of technical difficulties; absence of such notification will result in the link being considered invalid.",

            "Please note, in case a big win occurs and the balance of a player is lost - such funds shall not be considered as a part of commission fee relying to the Terms & Conditions of the Revenue Share and a Hybrid models.",

            "6.11. You hereby recognize that it is prohibited to create a game account under your own affiliate account in order to make a profit and/or return lost funds. If such accounts are detected, the company has the right to block the affiliate account and confiscate all funds received.",

            "6.12. Available payment methods.",

            "Within affiliate program of Dreamplay Affiliates can withdraw their commission funds using the following payment methods:",
    ...
    },
    {
        ...
        items: [
            ...
            "This Agreement is drafted in English. In the event of discrepancies between translations, the English version shall prevail.",
